        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <button class="btn btn-gradient-info btn-fw" data-toggle="modal" data-target="#Modal">Registrar género</button>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Registrar género</h5>
                          ...
                          <tr>
                            ...
                            <td> 
                              <a href="generoform.php?idgenero=<?=$f['idgenero'];?>">
                                <i class="mdi mdi-tooltip-edit menu-icon" style="cursor: pointer; font-size:20px; color: #047edf;" data-toggle="tooltip" data-placement="right" title="Actualizar género"></i>
                              </a>
                            </td>
                            <td> 
                              <a href="" data-toggle="modal" data-target="#exampleModal<?=$f['idgenero'];?>">
                                <i  class="mdi mdi-delete-circle menu-icon" style="cursor: pointer; font-size:20px; color: #047edf;" data-toggle="tooltip" data-placement="right" title="Eliminar género"></i>
                              </a>
                            </td>
                          </tr>
